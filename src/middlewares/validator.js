...
const registerCheck = [idCheck, passwordCheck, nameCheck, emailCheck, phoneCheck];
const resetpwCheck = [idCheck, emailCheck];

const meCheck = [emailCheck, phoneCheck];
...
const categoryCheck = [idCheck, nameCheck];

const putOrderCheck = [addressCheck, receiverCheck, receiverPhoneCheck];

const postOrderCheck = [itemsCheck, itemTotalCheck, uesrIdCheck, addressCheck, receiverCheck, receiverPhoneCheck];

const updateTotalCheck = [idCheck, priceCheck];
